...
.config(function($stateProvider, $urlRouterProvider) {
  ...
  .state('tecElectroElectrNica.gUAUNLaR', {
    url: '/page40',
    views: {
      'side-menu21': {
  ...
  .state('tecElectroElectrNica.finalInstalacionesI', {
    url: '/page41',
    views: {
      'side-menu21': {
        templateUrl: 'templates/finalInstalacionesI.html',
        controller: 'finalInstalacionesICtrl'
      }
    }
  })
